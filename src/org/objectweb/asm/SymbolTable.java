...
final class SymbolTable
{
    ...
    SymbolTable(final ClassWriter classWriter, final ClassReader classReader) {
        ...
        final byte[] inputBytes = classReader.b;
    ...
    Symbol addBootstrapMethod(final Handle bootstrapMethodHandle, final Object... bootstrapMethodArguments) {
        ...
        for (final Object bootstrapMethodArgument2 : bootstrapMethodArguments) {
            bootstrapMethodsAttribute.putShort(this.addConstant(bootstrapMethodArgument2).index);
        }
        ...
        for (final Object bootstrapMethodArgument3 : bootstrapMethodArguments) {
    ...
    int addMergedType(final int typeTableIndex1, final int typeTableIndex2) {
        final long data = (long)typeTableIndex1 | (long)typeTableIndex2 << 32;
