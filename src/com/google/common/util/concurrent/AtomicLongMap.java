...
public final class AtomicLongMap<K>
{
    ...
    public void removeAllZeros() {
        final Iterator<Map.Entry<K, AtomicLong>> entryIterator = this.map.entrySet().iterator();
        while (entryIterator.hasNext()) {
            final Map.Entry<K, AtomicLong> entry = entryIterator.next();
            final AtomicLong atomic = entry.getValue();
