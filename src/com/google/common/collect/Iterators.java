...
public final class Iterators
{
    ...
    public static <T> Iterator<T> concat(final Iterator<? extends T> a, final Iterator<? extends T> b) {
        ...
        return concat((Iterator<? extends Iterator<? extends T>>)new ConsumingQueueIterator<Iterator<? extends T>>((Iterator<? extends T>[])new Iterator[] { a, b }));
    }
    ...
    public static <T> Iterator<T> concat(final Iterator<? extends T> a, final Iterator<? extends T> b, final Iterator<? extends T> c) {
        ...
        return concat((Iterator<? extends Iterator<? extends T>>)new ConsumingQueueIterator<Iterator<? extends T>>((Iterator<? extends T>[])new Iterator[] { a, b, c }));
    }
    ...
    public static <T> Iterator<T> concat(final Iterator<? extends T> a, final Iterator<? extends T> b, final Iterator<? extends T> c, final Iterator<? extends T> d) {
        ...
        return concat((Iterator<? extends Iterator<? extends T>>)new ConsumingQueueIterator<Iterator<? extends T>>((Iterator<? extends T>[])new Iterator[] { a, b, c, d }));
    }
    ...
    public static <T> Iterator<T> concat(final Iterator<? extends T>... inputs) {
        ...
        return concat((Iterator<? extends Iterator<? extends T>>)new ConsumingQueueIterator<Iterator<? extends T>>((Iterator<? extends T>[])inputs));
    }
    ...
    private static class ConcatenatedIterator<T> extends MultitransformedIterator<Iterator<? extends T>, T>
    {
        public ConcatenatedIterator(final Iterator<? extends Iterator<? extends T>> iterators) {
            super(getComponentIterators((Iterator<? extends Iterator<?>>)iterators));
        }
            ...
            return new MultitransformedIterator<Iterator<? extends T>, Iterator<? extends T>>(iterators) {
                ...
                Iterator<? extends Iterator<? extends T>> transform(final Iterator<? extends T> iterator) {
                    if (iterator instanceof ConcatenatedIterator) {
                        final ConcatenatedIterator<? extends T> concatIterator = (ConcatenatedIterator<? extends T>)(ConcatenatedIterator)iterator;
                        return (Iterator<? extends Iterator<? extends T>>)getComponentIterators((Iterator<? extends Iterator<?>>)concatIterator.backingIterator);
                    }
