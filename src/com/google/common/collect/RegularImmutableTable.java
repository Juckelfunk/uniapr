...
abstract class RegularImmutableTable<R, C, V> extends ImmutableTable<R, C, V>
{
    ...
    private static final <R, C, V> RegularImmutableTable<R, C, V> forCellsInternal(final Iterable<Table.Cell<R, C, V>> cells, @Nullable final Comparator<? super R> rowComparator, @Nullable final Comparator<? super C> columnComparator) {
        ...
        final ImmutableSet<R> rowSpace = (rowComparator == null) ? ImmutableSet.copyOf((Collection<? extends R>)rowSpaceBuilder) : ImmutableSet.copyOf((Collection<? extends R>)Ordering.from(rowComparator).immutableSortedCopy(rowSpaceBuilder));
        final ImmutableSet<C> columnSpace = (columnComparator == null) ? ImmutableSet.copyOf((Collection<? extends C>)columnSpaceBuilder) : ImmutableSet.copyOf((Collection<? extends C>)Ordering.from(columnComparator).immutableSortedCopy(columnSpaceBuilder));
