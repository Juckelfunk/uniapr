...
public abstract class ByteSource
{
    ...
    public long size() throws IOException {
        ...
        try {
            ...
            final InputStream in = inputStream4 = inputStream3;
            final long exhaust = ByteStreams.exhaust(inputStream4);
            return exhaust;
        }
        try {
            ...
            final InputStream in = inputStream4 = inputStream3;
            final long exhaust2;
            final long exhaust = exhaust2 = ByteStreams.exhaust(inputStream4);
            return exhaust2;
        }
        catch (Throwable t) {}
    }
