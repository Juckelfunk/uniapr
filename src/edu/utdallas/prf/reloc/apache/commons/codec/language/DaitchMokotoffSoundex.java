...
package edu.utdallas.prf.reloc.apache.commons.codec.language;
...
import edu.utdallas.prf.reloc.apache.commons.codec.EncoderException;
import java.util.ArrayList;
import java.util.Scanner;
import java.util.List;
import java.util.Map;
import edu.utdallas.prf.reloc.apache.commons.codec.StringEncoder;
...
public class DaitchMokotoffSoundex implements StringEncoder
{
    ...
    private static final String RESOURCE_FILE = "edu/utdallas/prf/reloc/apache/commons/codec/language/dmrules.txt";
    ...
    static {
        ...
        final InputStream rulesIS = DaitchMokotoffSoundex.class.getClassLoader().getResourceAsStream("edu/utdallas/prf/reloc/apache/commons/codec/language/dmrules.txt");
        if (rulesIS == null) {
        ...
        parseRules(scanner, "edu/utdallas/prf/reloc/apache/commons/codec/language/dmrules.txt", DaitchMokotoffSoundex.RULES, DaitchMokotoffSoundex.FOLDINGS);
        scanner.close();
