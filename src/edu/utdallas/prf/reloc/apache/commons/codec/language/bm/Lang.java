...
package edu.utdallas.prf.reloc.apache.commons.codec.language.bm;
...
public class Lang
{
    ...
    private static final String LANGUAGE_RULES_RN = "edu/utdallas/prf/reloc/apache/commons/codec/language/bm/%s_lang.txt";
    ...
    static {
        ...
        for (final NameType s : NameType.values()) {
            Lang.Langs.put(s, loadFromResource(String.format("edu/utdallas/prf/reloc/apache/commons/codec/language/bm/%s_lang.txt", s.getName()), Languages.getInstance(s)));
        }
    }
